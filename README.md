...
<div align="center">
   <img src="https://i.imgur.com/TaC9lqh.png" title="source: imgur.com" width="90%"/>
</div>
...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/jessicatinguely/conta_bancaria) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/jessicatinguely/conta_bancaria.git
```
